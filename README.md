...
- Cold start on the scale-to-zero tier is **~48 seconds**; warm fleet answers in the numbers above. Pinned-warm capacity exists for workloads that can't tolerate the cold start.
